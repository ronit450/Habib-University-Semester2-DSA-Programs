...
def getAreaGraph():
    ...
    Edges = [
        ...
        ('Defence(Ph1,Ph2)', 'Shahrah e Faisal', 13),
        ...
        ('Defence(Ph4,Ph5,Gizri)', 'Shahrah e Faisal', 14),
        ...
        ('Defence(Ph6,Ph7,Ph8)', 'Shahrah e Faisal', 18),
        ...
        ('Gulshan e Iqbal', 'Defence(Ph1,Ph2)', 13),
        ('Gulshan e Iqbal', 'Defence(Ph4,Ph5,Gizri)', 18),
        ('Gulshan e Iqbal', 'Defence(Ph6,Ph7,Ph8)', 21),
        ...
        ('Shahrah e Faisal', 'Habib University', 8),
